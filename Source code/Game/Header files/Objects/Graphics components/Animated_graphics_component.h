...
namespace Game
{
	namespace Objects
	{
		...
		public:
			...
			//Animated_graphics_component* clone() override;
			...
			static Animated_graphics_component* from_json(const nlohmann::json& json, Game_object* game_object, const Component_loader& loader);
