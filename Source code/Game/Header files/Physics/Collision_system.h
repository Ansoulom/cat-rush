...
namespace Game
{
	...
	namespace Physics
	{
		...
		{
		public:
			std::vector<std::pair<Objects::Collider_component*, std::string_view>> get_collisions(
				const Objects::Collider_component& collider) const;
			std::vector<Objects::Collider_component*> get_collisions(const Geometry::Shape<double>& collider,
